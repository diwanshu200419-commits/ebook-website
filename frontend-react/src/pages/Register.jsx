  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-24">
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-8">Join E-Book Market and start learning or earning</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select 
              ...
              className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
            >
              <option value="reader">Read and learn</option>
              <option value="creator">Create and sell content</option>
            </select>
          </div>
          <button 
            type="submit" 
