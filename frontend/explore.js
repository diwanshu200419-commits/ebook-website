...
Object.assign(COPY.Hindi, COPY.English, {
  ...
  pulseTitle: "Marketplace Pulse",
  pulseDefaultHeadline: "Live demand creator-ready digital products ki taraf badh rahi hai.",
  pulseFilteredHeadline: "Aapke filters marketplace ko aur focused bana rahe hain.",
  pulseSearchHeadline: "Search ab catalog ko high-intent products tak la raha hai.",
  pulseCopy: "Hum live catalog se strong categories, pricing lanes aur language demand surface karte hain.",
  pulseStatusLive: "Market live",
  pulseStatusFiltered: "Filter active",
  statTotalProductsLabel: "Total live products",
  statPaidProductsLabel: "Paid earning assets",
  statCategoriesLabel: "Live categories",
  forYouTitle: "Aapke liye",
  filtersTitle: "Marketplace Filters",
  filtersCopy: "High-intent student products, creator resources aur trending digital assets khojiye.",
  searchLabel: "Khojiye",
  categoryLabel: "Category",
  languageLabel: "Language",
  sortLabel: "Sort",
  applyBtn: "Filters apply kijiye",
  searchPlaceholder: "Prompts, notes, AI templates, exam guides khojiye...",
  resultsTitle: "Live Marketplace",
  allCategories: "Sabhi categories",
  allLanguages: "Sabhi languages",
  quickAll: "Sabhi",
  signInRequired: "Sign in zaroori",
  guestFeedTitle: "Aapki AI discovery feed taiyar hai",
  guestFeedMessage: "Log in karke notes, prompts aur creator products ki personalized recommendations dekhiye.",
  signInForAiPicks: "AI picks ke liye Sign In",
  becomeCreator: "Creator baniye",
  loadingRecommendations: "AI discovery layer recommendations load kar rahi hai...",
  feedLearningSignal: "Signal learning",
  noPersonalizedTitle: "Abhi personalized picks nahin hain",
  noPersonalizedMessage: "Recommendation engine ko thodi aur browsing history chahiye.",
  feedLearningMeta: "Kuch live products browse kijiye aur feed aapke interests ke hisab se adapt karegi.",
  feedLearningStatus: "Aur activity chahiye",
  personalizedLiveMeta: "Aapke account signals ke aadhar par AI-ranked picks.",
  personalizedUnavailableTitle: "Personalized feed available nahin hai",
  personalizedUnavailableMessage: "Thodi der mein phir koshish kijiye.",
  loadingCatalogMeta: "Marketplace inventory refresh ho rahi hai...",
  loadingCatalogStatus: "Live catalog scan ho raha hai",
  noProductsTitle: "Koi product match nahin hua",
  noProductsMessage: "Broader search kijiye, doosri category chuniye, ya sort badalkar aur creator products dekhiye.",
  marketplaceUnavailableTitle: "Marketplace available nahin hai",
  marketplaceUnavailableMeta: "Abhi live products load nahin ho pa rahe.",
  productsSummary: "{total} products creator categories mein live hain",
  searchSummary: "\"{search}\" ke liye {total} matching products",
  languageSummary: "{language} mein {total} products live hain",
  followedReason: "Jis creator ko aap follow karte hain usse",
  addedToCartSignal: "Cart mein jod diya gaya",
  cartFailedSignal: "Cart update nahin ho paya",
  addedToCartMeta: "{message} Aap browsing jaari rakh sakte hain ya cart khol sakte hain.",
  noProductsFound: "Koi product nahin mila",
  noProductsFallback: "Doosra filter aazmaiye ya baad mein phir dekhiye.",
  commandDeckTitle: "Marketplace Command Deck",
  commandDeckCopy: "Saved ideas, recent product views aur agla buying move ek hi jagah track kijiye.",
  savedTitle: "Saved Ideas",
  savedCopy: "Promising creator products ko buy karne se pehle yahin save rakhiye.",
  recentTitle: "Recently Viewed",
  recentCopy: "Jo products aapne abhi dekhe the unpar jaldi wapas jaiye.",
  commandSavedMeta: "Compare, revisit, ya baad mein buy karne ke liye products yahan rakhiye.",
  commandRecentMeta: "Marketplace mein aapka latest discovery trail.",
  commandCartMeta: "Saves aur recents se purchase flow ko fast rakhiye.",
  commandSavedCta: "Saved rail kholo",
  commandRecentCta: "Recent rail kholo",
  commandCartCta: "Cart kholo",
  removeSaved: "Hataiye",
  memoryEmptySavedTitle: "Abhi koi saved product nahin hai",
  memoryEmptySavedCopy: "Jin products ko baad mein compare ya buy karna hai unpar Save tap kijiye.",
  memoryEmptyRecentTitle: "Abhi koi recent view nahin hai",
  memoryEmptyRecentCopy: "Kuch products kholo aur recent discovery trail yahan dikhne lagega.",
  savedToast: "Product aapki saved list mein aa gaya.",
  removedSavedToast: "Product saved list se hata diya gaya.",
  viewedNow: "Abhi dekha gaya",
  viewedAt: "{time} par dekha gaya",
});
